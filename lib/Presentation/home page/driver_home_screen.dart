        ...
        body: PageView.builder(
          ...
          itemBuilder: (context, index) {
            if (index == 0) {
              ...
              return const RecentRidesDriver(); // Use the RecentRidesDriver screen here
            } else if (index == 2) {
              return const PersonalInfoScreenDriver(); // Use the Driver's personal info screen here
            } else if (index == 3) {
              return const SettingsScreenDriver(); // Use the Driver's settings screen here
            } else {
